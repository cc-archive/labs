function cc_js_t(s) {
		 if (s == "Brazil") { return "Бразил"; } 
 if (s == "Canada") { return "Канада"; } 
 if (s == "Italy") { return "Италија"; } 
 if (s == "Creative Commons") { return "Криејтив комонс"; } 
 if (s == "Serbia") { return "Србија"; } 
 if (s == "Malta") { return "Малта"; } 
 if (s == "France") { return "Франција"; } 
 if (s == "Peru") { return "Перу"; } 
 if (s == "Argentina") { return "Аргентина"; } 
 if (s == "Norway") { return "Norway"; } 
 if (s == "New Zealand") { return "New Zealand"; } 
 if (s == "Ecuador") { return "Ecuador"; } 
 if (s == "Israel") { return "Израел"; } 
 if (s == "Australia") { return "Австралија"; } 
 if (s == "Korea") { return "Кореја"; } 
 ...
 if (s == "Slovenia") { return "Словенија"; } 
 ...
 if (s == "Belgium") { return "Белгија"; } 
 if (s == "Germany") { return "Германија"; } 
 ...
 if (s == "Poland") { return "Полска"; } 
 if (s == "Spain") { return "Шпанија"; } 
 ...
 if (s == "Netherlands") { return "Холандија"; } 
 if (s == "UK: England & Wales") { return "Велика Британија: Англија и Велс"; } 
 if (s == "Chile") { return "Чиле"; } 
 if (s == "Unported") { return "Unported"; } 
 if (s == "Denmark") { return "Данска"; } 
 if (s == "Philippines") { return "Филипини"; } 
 if (s == "Finland") { return "Финска"; } 
 if (s == "Macedonia") { return "Macedonia"; } 
 if (s == "United States") { return "САД"; } 
 if (s == "Sweden") { return "Шведска"; } 
 if (s == "No license chosen") { return "No license chosen"; } 
 if (s == "Croatia") { return "Хрватска"; } 
 if (s == "Luxembourg") { return "Луксембург"; } 
 if (s == "Japan") { return "Јапонија"; } 
 if (s == "Switzerland") { return "Швајцарија"; } 
 if (s == "UK: Scotland") { return "Велика Британија: Шкотска"; } 
 ...
 if (s == "Taiwan") { return "Тајван"; } 
 if (s == "If you desire a license governed by the Copyright Law of a specific jurisdiction, please select the appropriate jurisdiction.") { return "Ако сакате лиценца којашто ќе биде во согласност со Законот за авторски права во определен правен систем, ве молиме изберете соодветен правен систем."; } 
 if (s == "Bulgaria") { return "Бугарија"; } 
 if (s == "Romania") { return "Романија"; } 
 if (s == "Licensor permits others to make derivative works") { return "Licensor permits others to make derivative works"; } 
 if (s == "Portugal") { return "Португалија"; } 
 if (s == "Mexico") { return "Мексико"; } 
 if (s == "work") { return "дело"; } 
 if (s == "India") { return "Индија"; } 
 if (s == "South Africa") { return "Јужна Африка"; } 
 if (s == "Malaysia") { return "Малезија"; } 
 if (s == "Austria") { return "Австрија"; } 
 if (s == "Colombia") { return "Колумбија"; } 
 if (s == "Greece") { return "Greece"; } 
 if (s == "Hungary") { return "Унгарија"; } 
 if (s == "Share Alike") { return "Сподели под исти услови"; } 
 if (s == "China Mainland") { return "Кина"; } 
