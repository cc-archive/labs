...
FreedomsChooserClass.prototype = {
	...
	initialize:function(elementPrefix) {
		...
		this.centerLicense.style.left = "100px";
		this.centerLicense.style.top = "201px";
		...
		this.licenses = $H({
			...
			"by-nd":	{"share":1,"remix":0,"nc": 0,"sa":-1,"data":['2.5', 'Attribution-NoDerivs','Share:ND']},
			"by":		{"share":1,"remix":1,"nc": 0,"sa": 0,"data":['2.5', 'Attribution', 'Remix&Share']},
			"sampling":	{"share":0,"remix":1,"nc":-1,"sa":-1,"data":['1.0', 'Sampling', 'Remix']},
			"by-nc":	{"share":1,"remix":1,"nc": 1,"sa": 0,"data":['2.5','Attribution-NonCommercial','Remix&Share:NC']},
			"by-nc-sa":	{"share":1,"remix":1,"nc": 1,"sa": 1,"data":['2.5','Attribution-NonCommercial-ShareAlike','Remix&Share:NC:SA']},
			"by-sa":	{"share":1,"remix":1,"nc": 0,"sa": 1,"data":['2.5', 'Attribution-ShareAlike','Remix&Share:SA']},
			"by-nc-nd":	{"share":1,"remix":0,"nc": 1,"sa":-1,"data":['2.5','Attribution-NonCommercial-NoDerivs','Share:NC:ND']}
	...
	selectLicense:function(licenseId) {
		...
		if (license.data) {
			this.centerLicense.innerHTML = '<a href="#get_the_code">'+license.data[2]+'</a>';
